...
module.exports = {
    ...
    NBSK: process.env.ALL_NUMBER === undefined ? '919628516236' : process.env.ALL_NUMBER,
    ...
    YAK: process.env.YAK === undefined ? '919628516236' : process.env.YAK,
    ...
    SUDO: process.env.SUDO === undefined ? '919628516236,0' : process.env.SUDO,
    DEBUG: DEBUG,
